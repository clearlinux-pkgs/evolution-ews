...
Source0  : https://download.gnome.org/sources/evolution-ews/3.24/evolution-ews-3.24.2.tar.xz
...
%prep
%setup -q -n evolution-ews-3.24.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1494426914
mkdir clr-build
pushd clr-build
