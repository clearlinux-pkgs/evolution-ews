...
Version  : 3.26.6
Release  : 14
URL      : https://download.gnome.org/sources/evolution-ews/3.26/evolution-ews-3.26.6.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.26/evolution-ews-3.26.6.tar.xz
...
%prep
%setup -q -n evolution-ews-3.26.6
...
export LANG=C
export SOURCE_DATE_EPOCH=1520610020
mkdir clr-build
pushd clr-build
