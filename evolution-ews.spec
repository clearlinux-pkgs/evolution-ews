...
Version  : 3.28.4
Release  : 22
URL      : https://download.gnome.org/sources/evolution-ews/3.28/evolution-ews-3.28.4.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.28/evolution-ews-3.28.4.tar.xz
...
%prep
%setup -q -n evolution-ews-3.28.4
...
export LANG=C
export SOURCE_DATE_EPOCH=1531757887
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
