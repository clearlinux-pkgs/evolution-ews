...
Source0  : https://download.gnome.org/sources/evolution-ews/3.34/evolution-ews-3.34.1.tar.xz
...
%prep
%setup -q -n evolution-ews-3.34.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570464051
mkdir -p clr-build
pushd clr-build
