...
Source0  : https://download.gnome.org/sources/evolution-ews/3.44/evolution-ews-3.44.4.tar.xz
...
%prep
%setup -q -n evolution-ews-3.44.4
cd %{_builddir}/evolution-ews-3.44.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659984469
mkdir -p clr-build
pushd clr-build
