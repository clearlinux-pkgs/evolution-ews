...
Source0  : https://download.gnome.org/sources/evolution-ews/3.28/evolution-ews-3.28.5.tar.xz
...
%prep
%setup -q -n evolution-ews-3.28.5
...
export LANG=C
export SOURCE_DATE_EPOCH=1532969557
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
