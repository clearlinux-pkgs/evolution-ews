...
Version  : 3.32.2
Release  : 34
URL      : https://download.gnome.org/sources/evolution-ews/3.32/evolution-ews-3.32.2.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.32/evolution-ews-3.32.2.tar.xz
...
%prep
%setup -q -n evolution-ews-3.32.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1557162370
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
