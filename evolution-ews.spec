...
Version  : 3.24.3
Release  : 4
URL      : https://download.gnome.org/sources/evolution-ews/3.24/evolution-ews-3.24.3.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.24/evolution-ews-3.24.3.tar.xz
...
%prep
%setup -q -n evolution-ews-3.24.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1497906648
mkdir clr-build
pushd clr-build
