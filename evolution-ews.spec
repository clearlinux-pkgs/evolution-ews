...
Version  : 3.26.5
Release  : 13
URL      : https://download.gnome.org/sources/evolution-ews/3.26/evolution-ews-3.26.5.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.26/evolution-ews-3.26.5.tar.xz
...
%prep
%setup -q -n evolution-ews-3.26.5
...
export LANG=C
export SOURCE_DATE_EPOCH=1517847681
mkdir clr-build
pushd clr-build
