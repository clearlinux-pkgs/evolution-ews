...
Source0  : https://download.gnome.org/sources/evolution-ews/3.24/evolution-ews-3.24.1.tar.xz
...
%prep
%setup -q -n evolution-ews-3.24.1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1492174632
mkdir clr-build
pushd clr-build
