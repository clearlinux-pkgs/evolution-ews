...
Source0  : https://download.gnome.org/sources/evolution-ews/3.38/evolution-ews-3.38.1.tar.xz
...
%prep
%setup -q -n evolution-ews-3.38.1
cd %{_builddir}/evolution-ews-3.38.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601655534
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/evolution-ews-3.38.1/COPYING %{buildroot}/usr/share/package-licenses/evolution-ews/4df5d4b947cf4e63e675729dd3f168ba844483c7
pushd clr-build
%make_install
popd
