...
Source0  : https://download.gnome.org/sources/evolution-ews/3.54/evolution-ews-3.54.3.0.tar.xz
...
%prep
%setup -q -n evolution-ews-3.54.3.0
cd %{_builddir}/evolution-ews-3.54.3.0
pushd ..
cp -a evolution-ews-3.54.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736796841
mkdir -p clr-build
pushd clr-build
