...
Version  : 3.24.5
Release  : 6
URL      : https://download.gnome.org/sources/evolution-ews/3.24/evolution-ews-3.24.5.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.24/evolution-ews-3.24.5.tar.xz
...
%prep
%setup -q -n evolution-ews-3.24.5
...
export LANG=C
export SOURCE_DATE_EPOCH=1502128847
mkdir clr-build
pushd clr-build
