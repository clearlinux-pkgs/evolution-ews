...
Version  : 3.54.2
Release  : 88
URL      : https://download.gnome.org/sources/evolution-ews/3.54/evolution-ews-3.54.2.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.54/evolution-ews-3.54.2.tar.xz
...
%prep
%setup -q -n evolution-ews-3.54.2
cd %{_builddir}/evolution-ews-3.54.2
pushd ..
cp -a evolution-ews-3.54.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732555053
mkdir -p clr-build
pushd clr-build
