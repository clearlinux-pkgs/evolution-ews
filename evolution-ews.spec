...
Version  : 3.26.2
Release  : 9
URL      : https://download.gnome.org/sources/evolution-ews/3.26/evolution-ews-3.26.2.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.26/evolution-ews-3.26.2.tar.xz
...
%prep
%setup -q -n evolution-ews-3.26.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1510173975
mkdir clr-build
pushd clr-build
