...
Version  : 3.52.3
Release  : 84
URL      : https://download.gnome.org/sources/evolution-ews/3.52/evolution-ews-3.52.3.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.52/evolution-ews-3.52.3.tar.xz
...
%prep
%setup -q -n evolution-ews-3.52.3
cd %{_builddir}/evolution-ews-3.52.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719591797
mkdir -p clr-build
pushd clr-build
