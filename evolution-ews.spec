...
Source0  : https://download.gnome.org/sources/evolution-ews/3.26/evolution-ews-3.26.3.tar.xz
...
%prep
%setup -q -n evolution-ews-3.26.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1513084354
mkdir clr-build
pushd clr-build
