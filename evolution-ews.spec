...
Version  : 3.46.1
Release  : 67
URL      : https://download.gnome.org/sources/evolution-ews/3.46/evolution-ews-3.46.1.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.46/evolution-ews-3.46.1.tar.xz
...
%prep
%setup -q -n evolution-ews-3.46.1
cd %{_builddir}/evolution-ews-3.46.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666363479
mkdir -p clr-build
pushd clr-build
