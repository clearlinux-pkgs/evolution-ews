...
Version  : 3.50.3
Release  : 80
URL      : https://download.gnome.org/sources/evolution-ews/3.50/evolution-ews-3.50.3.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.50/evolution-ews-3.50.3.tar.xz
...
%prep
%setup -q -n evolution-ews-3.50.3
cd %{_builddir}/evolution-ews-3.50.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704488228
mkdir -p clr-build
pushd clr-build
