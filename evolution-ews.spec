...
Source0  : https://download.gnome.org/sources/evolution-ews/3.28/evolution-ews-3.28.1.tar.xz
...
%prep
%setup -q -n evolution-ews-3.28.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1523280980
mkdir clr-build
pushd clr-build
