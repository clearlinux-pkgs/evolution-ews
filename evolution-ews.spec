...
Source0  : https://download.gnome.org/sources/evolution-ews/3.36/evolution-ews-3.36.0.tar.xz
...
%prep
%setup -q -n evolution-ews-3.36.0
cd %{_builddir}/evolution-ews-3.36.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585174589
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/evolution-ews-3.36.0/COPYING %{buildroot}/usr/share/package-licenses/evolution-ews/4df5d4b947cf4e63e675729dd3f168ba844483c7
pushd clr-build
%make_install
popd
