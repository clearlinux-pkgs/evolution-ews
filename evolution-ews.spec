...
Source0  : https://download.gnome.org/sources/evolution-ews/3.28/evolution-ews-3.28.0.tar.xz
...
%prep
%setup -q -n evolution-ews-3.28.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1522194961
mkdir clr-build
pushd clr-build
