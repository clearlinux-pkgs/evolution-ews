...
Version  : 3.30.3
Release  : 28
URL      : https://download.gnome.org/sources/evolution-ews/3.30/evolution-ews-3.30.3.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.30/evolution-ews-3.30.3.tar.xz
...
%prep
%setup -q -n evolution-ews-3.30.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1546878629
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
