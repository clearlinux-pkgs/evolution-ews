...
Source0  : https://download.gnome.org/sources/evolution-ews/3.30/evolution-ews-3.30.5.tar.xz
...
%prep
%setup -q -n evolution-ews-3.30.5
...
export LANG=C
export SOURCE_DATE_EPOCH=1549301133
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
