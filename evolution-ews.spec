...
Version  : 3.50.1
Release  : 78
URL      : https://download.gnome.org/sources/evolution-ews/3.50/evolution-ews-3.50.1.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.50/evolution-ews-3.50.1.tar.xz
...
%prep
%setup -q -n evolution-ews-3.50.1
cd %{_builddir}/evolution-ews-3.50.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697840718
mkdir -p clr-build
pushd clr-build
