...
Source0  : https://download.gnome.org/sources/evolution-ews/3.56/evolution-ews-3.56.1.tar.xz
...
%prep
%setup -q -n evolution-ews-3.56.1
cd %{_builddir}/evolution-ews-3.56.1
pushd ..
cp -a evolution-ews-3.56.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744388702
mkdir -p clr-build
pushd clr-build
