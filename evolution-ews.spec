...
Version  : 3.42.4
Release  : 57
URL      : https://download.gnome.org/sources/evolution-ews/3.42/evolution-ews-3.42.4.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.42/evolution-ews-3.42.4.tar.xz
...
%prep
%setup -q -n evolution-ews-3.42.4
cd %{_builddir}/evolution-ews-3.42.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644881333
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/evolution-ews-3.42.4/COPYING %{buildroot}/usr/share/package-licenses/evolution-ews/4df5d4b947cf4e63e675729dd3f168ba844483c7
pushd clr-build
%make_install
popd
