...
Version  : 3.46.3
Release  : 69
URL      : https://download.gnome.org/sources/evolution-ews/3.46/evolution-ews-3.46.3.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.46/evolution-ews-3.46.3.tar.xz
...
%prep
%setup -q -n evolution-ews-3.46.3
cd %{_builddir}/evolution-ews-3.46.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673018327
mkdir -p clr-build
pushd clr-build
