...
Source0  : https://download.gnome.org/sources/evolution-ews/3.52/evolution-ews-3.52.4.tar.xz
...
%prep
%setup -q -n evolution-ews-3.52.4
cd %{_builddir}/evolution-ews-3.52.4
pushd ..
cp -a evolution-ews-3.52.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722625155
mkdir -p clr-build
pushd clr-build
