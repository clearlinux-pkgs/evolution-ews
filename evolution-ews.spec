...
Version  : 3.30.2
Release  : 27
URL      : https://download.gnome.org/sources/evolution-ews/3.30/evolution-ews-3.30.2.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.30/evolution-ews-3.30.2.tar.xz
...
%prep
%setup -q -n evolution-ews-3.30.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1542316854
mkdir -p clr-build
pushd clr-build
%cmake ..
