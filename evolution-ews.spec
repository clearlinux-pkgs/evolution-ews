...
Version  : 3.34.0
Release  : 35
URL      : https://download.gnome.org/sources/evolution-ews/3.34/evolution-ews-3.34.0.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.34/evolution-ews-3.34.0.tar.xz
...
%prep
%setup -q -n evolution-ews-3.34.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568063244
mkdir -p clr-build
pushd clr-build
