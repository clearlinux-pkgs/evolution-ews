...
Source0  : https://download.gnome.org/sources/evolution-ews/3.26/evolution-ews-3.26.0.tar.xz
...
%prep
%setup -q -n evolution-ews-3.26.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1505147102
mkdir clr-build
pushd clr-build
