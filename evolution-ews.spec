...
Version  : 3.54.1
Release  : 87
URL      : https://download.gnome.org/sources/evolution-ews/3.54/evolution-ews-3.54.1.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.54/evolution-ews-3.54.1.tar.xz
...
%prep
%setup -q -n evolution-ews-3.54.1
cd %{_builddir}/evolution-ews-3.54.1
pushd ..
cp -a evolution-ews-3.54.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729265660
mkdir -p clr-build
pushd clr-build
