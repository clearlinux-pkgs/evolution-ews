...
Source0  : https://download.gnome.org/sources/evolution-ews/3.50/evolution-ews-3.50.2.tar.xz
...
%prep
%setup -q -n evolution-ews-3.50.2
cd %{_builddir}/evolution-ews-3.50.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703619624
mkdir -p clr-build
pushd clr-build
