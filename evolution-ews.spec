...
Source0  : https://download.gnome.org/sources/evolution-ews/3.52/evolution-ews-3.52.0.tar.xz
...
%prep
%setup -q -n evolution-ews-3.52.0
cd %{_builddir}/evolution-ews-3.52.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710889121
mkdir -p clr-build
pushd clr-build
