...
Version  : 3.26.1
Release  : 8
URL      : https://download.gnome.org/sources/evolution-ews/3.26/evolution-ews-3.26.1.tar.xz
Source0  : https://download.gnome.org/sources/evolution-ews/3.26/evolution-ews-3.26.1.tar.xz
...
%prep
%setup -q -n evolution-ews-3.26.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1506958762
mkdir clr-build
pushd clr-build
